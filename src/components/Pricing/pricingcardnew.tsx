...
const PricingCardNew: React.FC<PricingCardProps> = ({
  ...
  return (
    <div className="relative flex flex-col md:flex-row bg-white  shadow-md hover:shadow-xl transition-shadow duration-300 ">
      {popular && (
      ...
      {/* Left Section */}
      <div className="flex-shrink-0 bg-gradient-to-r from-blue-500 to-blue-700 text-white p-6 md:p-8 flex flex-col justify-center items-center w-full md:w-1/3">
      ...
      <div className="flex-grow p-4 md:p-6 space-y-4">
        ...
        <div>
          <button
            onClick={handleClick}
            className="mt-4 w-full py-2 md:py-3 text-white bg-blue-600 rounded-md text-sm md:text-base font-semibold hover:bg-blue-700 transition-colors"
          >
            {buttonLabel}
          </button>
        </div>

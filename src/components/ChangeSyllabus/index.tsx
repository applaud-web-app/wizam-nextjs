...
interface ChangeSyllabusProps {
  updateSyllabusStatus: () => void; // Receive the prop to handle syllabus update
}
...
export default function ChangeSyllabus({ updateSyllabusStatus }: ChangeSyllabusProps) {
  ...
  const handleSyllabusClick = (name: string, id: number) => {
    ...
    // Update syllabus status in parent component
    updateSyllabusStatus();

    // Redirect to dashboard after selecting a syllabus

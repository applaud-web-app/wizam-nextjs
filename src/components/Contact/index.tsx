...
const Contact: React.FC = () => {
          ...
          <div className="w-full lg:w-6/12 p-12 bg-tertiary text-white flex flex-col ">
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <p>{siteSettings?.address || "3 The Mount, London W3 9NW, United Kingdom"}</p>
                </li>
                <li className="flex items-start space-x-3">
            ...
            <div className="mb-3">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                ...
                <li>10-minute walk from Acton Town Underground Station / Acton Main/Acton Central.</li>
  ...
  <div className="grid grid-cols-1  gap-4">
    ...
    {formik.touched.accept_condition && formik.errors.accept_condition && (
      <p className="col-span-2 text-red-500 text-sm">{formik.errors.accept_condition}</p>
    )}
    ...
    <div className="col-span-1 sm:col-span-1">
      <button
        type="submit"
        className="w-full bg-primary text-white py-3 rounded-md hover:bg-primary-dark focus:ring-2 focus:ring-primary focus:border-white"
        disabled={loading}
      >

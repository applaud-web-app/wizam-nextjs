      ...
      {!submitted && timeLeft > 0 && (
        <div className="w-full md:w-1/3 bg-white shadow-sm rounded-lg">
          <div className="p-4 flex items-center space-x-3">
            ...
            <p>
              {currentQuestionIndex + 1}/{practiceData.questions.length} answered
            </p>
          </div>
          ...
          <div className="px-4 py-6  bg-gray-100  border-y  border-gray-200">
            <div className="h-3 w-full bg-gray-200 rounded-full relative">
              <div
                ...
                style={{
                  width: `${
                    (Object.keys(answers).length / practiceData.questions.length) *
                    100
                  }%`,
                }}
              ></div>
              <span
                ...
                style={{
                  left: `${
                    ((Object.keys(answers).length / practiceData.questions.length) * 100) - 2
                  }%`,
                }}
              >
                {Math.round(
                  (Object.keys(answers).length / practiceData.questions.length) * 100
                )}
                %
              </span>
            </div>
